...
def test_exclusions_and_manifest_entries_remain_coherent():
    ...
    assert by_id["PRO-017"]["current_implementation_basis"] == "false"
    assert by_id["PRO-017"]["frozen"] == "true"
    assert by_id["PRO-017"]["superseded_by"] == "v1.1"
    assert by_id["PRO-018"]["version"] == "v1.1"
    assert by_id["PRO-018"]["current_implementation_basis"] == "true"
    assert by_id["PRO-018"]["frozen"] == "true"

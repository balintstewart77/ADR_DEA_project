...
import html
from prototype_lib import ROOT, default_valid_submission, load_json, package_case, write_data_quality_rules, write_dictionary, write_record_import
...
def main():
    ...
    for package in packages:
        ...
        for code, label in (("dom", "Domains"), ("purp", "Purposes"), ("covid", "COVID-19/pandemic"), ("equity", "Equity")):
            ...
            branch = "Differs: evidence, best supported, sufficient support and defensible options asked" if len(interps) > 1 else "Does not differ: no component questions"
            questions = "Asked blind for a differing component: how much information the entry gives; which option or options are best supported (ties named); whether any complete option is sufficiently supported; and which options are defensible."

...
v0.15. The engine implements the unchanged 150/100 baseline draw, forced
...
v0.15 remains a review candidate, so this binding does not freeze or authorise a
draw.
...
token. The current v0.15 review-candidate metadata fails that guard by design.

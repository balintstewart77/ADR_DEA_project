...
row. The current v0.11-aligned repository version is redcap-candidate-0.5.
...
Candidate 0.4 made two diagnostic-instrument changes that candidate 0.5 retains:
...
Candidate 0.5 adds hidden owner recruitment-route, sequence-position,
...
reserve. It remains provisional pending pilot closure, Jo's review, propagation
of resulting changes, repository QA, and fresh live runtime QA. The dated 16
July runtime record is historical and does not establish candidate-0.5 readiness.

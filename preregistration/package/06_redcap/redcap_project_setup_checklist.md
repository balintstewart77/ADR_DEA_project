# REDCap project setup checklist — candidate 0.6
...
- [ ] Import candidate-0.6 only after repository validation and protocol gates pass.
- [ ] Record the actual REDCap version and candidate-0.6 dictionary hash.
- [ ] Record every import warning; confirm form order and 145 fields.
...
- [ ] Use only synthetic new records for candidate-0.6 runtime QA.
- [ ] Execute every candidate-0.6 branch, response-code and field-note test in the QA
      checklist and blank runtime template.
- [ ] Confirm one assignment per export row and hidden project clustering.
- [ ] Delete candidate-0.6 synthetic records after QA.
- [ ] Do not begin formal coding until candidate-0.6 runtime QA is signed off.

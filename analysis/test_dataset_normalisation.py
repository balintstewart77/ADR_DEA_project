...
class DatasetNormalisationTest(unittest.TestCase):
    def test_manual_aliases(self):
        cases = {
            ...
            "Business Impact of COVID-19": "Business Insights and Conditions Survey (BICS)",
            "Business Impact of COVID-19 Survey": "Business Insights and Conditions Survey (BICS)",
            "Business Impact of COVID19 Survey": "Business Insights and Conditions Survey (BICS)",
    ...
    def test_provider_normalisation(self):
        cases = {
            ...
            "Office for national Statistics": "Office for National Statistics (ONS)",
            "Office of National Statistics": "Office for National Statistics (ONS)",
            "Offcie for National Statistics": "Office for National Statistics (ONS)",
            "Department for Business, Energy & Industrial Strategy": "Department for Business, Energy and Industrial Strategy (BEIS)",
            ...
            "Intellectual Property Office - UK DBT": "Intellectual Property Office (IPO)",

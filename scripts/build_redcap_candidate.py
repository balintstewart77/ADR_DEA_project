...
def build_fixtures():
 adm={'assignment_id':'B6J4K8M2','review_stream':1,'sample_set':1,'validation_included':1}; sc={'assignment_id':'A7K3M9Q2','sc_blind_decl':1,'sc_exposure':0,'sc_domains':[1],'sc_purposes':[1],'sc_covid':0,'sc_equity':0,'sc_sufficiency':1,'sc_taxonomy_fit':1,'sc_confidence':1}; po={'assignment_id':'Q4N8Z2L7','cluster_id':'SYNTH-PROJECT-A','owner_resp_id':'SYNTH-OWNER-A','prop_d01':1,'po_d01_fit':1,'po_d01_vis':1,'po_miss_domain':0,'po_miss_purpose':0,'po_miss_tag':0,'po_sufficiency':1,'po_taxonomy_fit':1}; cases=[]
